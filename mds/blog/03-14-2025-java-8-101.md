# All about Java (8, the ugly version)

Writing this blog post to finalize the knowledge gained from my last uni course that will be used during my Amazon internship.

Before starting, you need basic OOP knowledge...Why? Because from now on everything will be an object and we will turn into objects as well.
